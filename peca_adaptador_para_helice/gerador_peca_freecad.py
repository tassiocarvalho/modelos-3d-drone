...
diametro_furo = 3.2  # em mm
profundidade_furo = 7  # em mm
...
profundidade_furo_fundo = 7  # em mm
...
furo_horizontal.translate(Base.Vector(-diametro/2, 0, 4))  # Posicionar o furo no centro lateral a 4mm de altura
