...
# O topo da peça final (cilindro adicional) está em z = 8.5 + 10 = 18.5 mm
...
# Transladar para que o topo do furo fique em z = 18.5 e a base em z = 5.5
furo_central.translate(App.Vector(0, 0, 18.5 - 13.0))
...
print("Peça com cilindro adicional colada criada com sucesso, agora com furo central de 2 mm por 13 mm de profundidade!")
import FreeCAD as App
import Part
import math
from FreeCAD import Base
