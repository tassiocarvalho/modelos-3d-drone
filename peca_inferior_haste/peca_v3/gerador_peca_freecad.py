...
# Dimensões do bloco inferior (ajustadas para o tamanho do cubo)
largura = cubo_lado  # mm
comprimento = cubo_lado  # mm
altura = 17  # mm
furo_lado = 13  # mm
furo_altura = 20  # mm
furo_baixo = 2.05
...
# Criar o bloco inferior com o mesmo tamanho do cubo
...
furo1 = Part.makeCylinder(furo_baixo, furo_altura)
...
furo2 = Part.makeCylinder(furo_baixo, furo_altura)
...
# Criar os furos cilíndricos no cubo
furo_baixo = furo_raio  # O raio do furo no cubo

# Furo 1 no cubo
furo1_posicao_y_cubo = 5  # mm (medida do centro do furo até a borda)
furo1_cubo = Part.makeCylinder(furo_baixo, furo_altura2)
furo1_cubo.translate(App.Vector(cubo_lado / 2, furo1_posicao_y_cubo, 0))

# Furo 2 no cubo
furo2_posicao_y_cubo = 5 + 15  # 5 mm do centro do primeiro furo + 15 mm de distância entre os furos
furo2_cubo = Part.makeCylinder(furo_baixo, furo_altura2)
furo2_cubo.translate(App.Vector(cubo_lado / 2, furo2_posicao_y_cubo, 0))

# Subtrair os furos cilíndricos do cubo
cubo_com_furos = cubo_com_furos.cut(furo1_cubo).cut(furo2_cubo)
...
# Salvar o documento
doc.saveAs('Montagem_Cubo_Bloco_Com_Furos.FCStd')
